...
def Create():
    ...
    global heli_image, heli_image_flipped, paratrooper_image, parachute_image, plane_image, plane_image_flipped
...
def Draw(elapsed):
    ...
    for i in range(0, 10):
        SimpleGraphics.DrawBlock(0, i * (screen_height / 10), screen_width, screen_height / 10, (i / 10) * 255, 0, 0, True)
